---
name: daily-report-lane-product-hunt
description: Generate the Product Hunt 新品 section of the AI Agent daily report from raw corpus.
---
# Product Hunt 新品 Lane
## Mission
Product Hunt 上 2-3 个 AI/coding-agent 相关新品。
## Input
...
Select 2-3 AI/coding-agent relevant products. Reject generic SaaS or broad productivity launches. Keep Product Hunt links.
