---
name: daily-report-lane-github-ai-projects
description: Generate the GitHub AI 项目 section of the AI Agent daily report from raw corpus.
---
# GitHub AI 项目 Lane
## Mission
主动发现 GitHub AI/coding-agent 项目，不能用旧 shared memory 文件作为集成点。
## Input
...
Run internal discovery or evidence helper when useful. Never use the old shared memory output as integration point. Treat discovery output as evidence only; the subagent still selects/rejects and writes. Select only projects relevant to AI/coding-agent workflows.
