---
name: daily-report-lane-hacker-news-search
description: Generate the HN 搜索 section of the AI Agent daily report from raw corpus.
---
# HN 搜索 Lane
## Mission
HN 搜索补充的 AI/coding-agent 相关讨论。
## Input
